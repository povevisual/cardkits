...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Create New Bio Link</h1>
        </div>

        <form action="{{ route('bio-links.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
            @csrf
            ...
            <div class="mt-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input type="color" name="theme_color" id="theme_color" value="{{ old('theme_color', '#000000') }}"
                    ...
                    <div>
                        ...
                        <input type="color" name="button_color" id="button_color" value="{{ old('button_color', '#007bff') }}"
                               class="w-full h-10 border border-gray-300 rounded-md">
                    </div>
                ...
                <div>
                    ...
                    <select name="font_family" id="font_family" 
                        ...
                        <option value="Open Sans" {{ old('font_family') == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                        <option value="Lato" {{ old('font_family') == 'Lato' ? 'selected' : '' }}>Lato</option>
            ...
            <div class="mt-8 space-y-4">
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="show_social_icons" id="show_social_icons" value="1" {{ old('show_social_icons', true) ? 'checked' : '' }}
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="show_analytics" id="show_analytics" value="1" {{ old('show_analytics') ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
